...
export const GOAL_CONFIGS = {
  strength: {
    name: 'Forza',
    repsRange: '3-5',  // Start da 3, target 12-15 per unlock
    ...
    unlockThreshold: 12,  // Quando arrivi a 12-15 reps, testa livello successivo
    startReps: 3,  // Parti sempre da 3 reps
    weeklyProgression: 'linear_first_set'  // +1 rep sul primo set ogni 1-2 settimane
  },
  
  muscle_gain: {
    name: 'Ipertrofia',
    repsRange: '12-25',  // Range flessibile 12-30
    rest: { compound: 90, accessory: 75, isolation: 60, core: 60 },
    intensity: 'high',  // RIR 0-1 (cedimento)
    focus: 'time_under_tension',
    setsMultiplier: 1.2,  // Volume alto
    notes: 'TUT, Superset, Giant Set',
    homeStrategy: 'time_under_tension',
    techniques: ['tempo_313', 'superset', 'giant_set', 'dropset'],
    targetRIR: 1  // Vicino al cedimento
  },
  ...
  performance: {
    ...
    repsRange: '4-8',  // Reps efficaci e allenanti, esplosive
  ...
  motor_recovery: {
    ...
    painThreshold: true,  // Rispetta limiti dolore
    progressionOrder: ['difficulty', 'load', 'rom']  // Ordine progressione
  }
}
...
export const EXERCISE_PROGRESSIONS = {
  ...
  'Squat': {
    strength: [
      ...
      { name: 'Pistol Completo', level: 6, unlockReps: 15 }  // Ultimo livello: accumula volume
    ],
...
console.log('✅ GOAL_CONFIGS_COMPLETE loaded');
