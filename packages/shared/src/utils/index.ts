...
// TrainMaster - Session Adaptation Engine
export type {
  MenstrualPhase,
  SessionContext,
  SessionAdaptation,
  MenstrualPhaseOptimization,
  PainDeloadResult,
  PainRecoveryStep,
  PainFlowResult,
  ExerciseAlternative as TrainMasterAlternative
} from './TrainMaster';
export {
  // Stress
  ...
  // Sleep
  calculateSleepReduction,
  calculateSleepQualityFactor,
  getSleepRecommendations,
  // Menstrual Cycle
  determineMenstrualPhase,
  getMenstrualPhaseOptimization,
  getMenstrualIntensityMultiplier,
  getMenstrualVolumeMultiplier,
  MENSTRUAL_PHASE_OPTIMIZATIONS,
  // Pain Management (2-step recovery)
  applyPainDeload as trainMasterApplyPainDeload,
  handleExercisePain,
  getRecurringPainDisclaimer,
  // Equipment Alternatives
  getExerciseAlternatives as trainMasterGetAlternatives,
  calculateAlternativeParams,
  EXERCISE_ALTERNATIVES as TRAINMASTER_ALTERNATIVES,
  // Consolidated
  calculateSessionAdaptation,
  generatePreWorkoutWarnings
} from './TrainMaster';
export { default as TrainMaster } from './TrainMaster';
